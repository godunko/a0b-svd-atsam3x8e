...
package A0B.SVD.ATSAM3X8E.CAN is
   pragma Preelaborate;
...
--  Edge)
   ...
   type CAN0_MR_Register is record
      ...
      --  Reception Synchronization Stage (not readable)
      RXSYNC         : MR_RXSYNC_Field := A0B.SVD.ATSAM3X8E.CAN.DOUBLE_PP;
      --  unspecified
...
--  period, centered on sample point.
   ...
   type CAN0_BR_Register is record
      ...
      --  Sampling Mode
      SMP            : BR_SMP_Field := A0B.SVD.ATSAM3X8E.CAN.ONCE;
      --  unspecified
...
--  sending its contents.
   ...
   type MMR_Register is record
      ...
      --  Mailbox Object Type
      MOT            : MMR0_MOT_Field := A0B.SVD.ATSAM3X8E.CAN.MB_DISABLED;
      --  unspecified
      Reserved_27_31 : A0B.Types.SVD.UInt5 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
