...
--  DMA Controller
package A0B.SVD.ATSAM3X8E.DMAC is
   pragma Preelaborate;
   ...
   type DMAC_GCFG_Register is record
      ...
      ARB_CFG       : GCFG_ARB_CFG_Field :=
                       A0B.SVD.ATSAM3X8E.DMAC.ROUND_ROBIN;
      --  unspecified
   ...
   type CTRLA_Register is record
      ...
      --  Source Chunk Transfer Size.
      SCSIZE         : CTRLA0_SCSIZE_Field := A0B.SVD.ATSAM3X8E.DMAC.CHK_1;
      --  unspecified
      Reserved_19_19 : A0B.Types.SVD.Bit := 16#0#;
      --  Destination Chunk Transfer Size
      DCSIZE         : CTRLA0_DCSIZE_Field := A0B.SVD.ATSAM3X8E.DMAC.CHK_1;
      --  unspecified
      Reserved_23_23 : A0B.Types.SVD.Bit := 16#0#;
      --  Transfer Width for the Source
      SRC_WIDTH      : CTRLA0_SRC_WIDTH_Field := A0B.SVD.ATSAM3X8E.DMAC.BYTE;
      --  unspecified
      Reserved_26_27 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Transfer Width for the Destination
      DST_WIDTH      : CTRLA0_DST_WIDTH_Field := A0B.SVD.ATSAM3X8E.DMAC.BYTE;
      --  unspecified
...
--  memory.
   ...
   type CTRLB_Register is record
      ...
      SRC_DSCR       : CTRLB0_SRC_DSCR_Field :=
                        A0B.SVD.ATSAM3X8E.DMAC.FETCH_FROM_MEM;
      --  unspecified
      ...
      --  Flow Control
      FC             : CTRLB0_FC_Field :=
                        A0B.SVD.ATSAM3X8E.DMAC.MEM2MEM_DMA_FC;
      --  unspecified
      Reserved_23_23 : A0B.Types.SVD.Bit := 16#0#;
      --  Incrementing, Decrementing or Fixed Address for the Source
      SRC_INCR       : CTRLB0_SRC_INCR_Field :=
                        A0B.SVD.ATSAM3X8E.DMAC.INCREMENTING;
      --  unspecified
      Reserved_26_27 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Incrementing, Decrementing or Fixed Address for the Destination
...
--  then the request is serviced.
   ...
   type CFG_Register is record
      ...
      --  Software or Hardware Selection for the Source
      SRC_H2SEL      : CFG0_SRC_H2SEL_Field := A0B.SVD.ATSAM3X8E.DMAC.SW;
      --  unspecified
      Reserved_10_12 : A0B.Types.SVD.UInt3 := 16#0#;
      --  Software or Hardware Selection for the Destination
      DST_H2SEL      : CFG0_DST_H2SEL_Field := A0B.SVD.ATSAM3X8E.DMAC.SW;
      --  unspecified
      Reserved_14_15 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Stop On Done
      SOD            : CFG0_SOD_Field := A0B.SVD.ATSAM3X8E.DMAC.DISABLE;
      --  unspecified
      Reserved_17_19 : A0B.Types.SVD.UInt3 := 16#0#;
      --  Interface Lock
      LOCK_IF        : CFG0_LOCK_IF_Field := A0B.SVD.ATSAM3X8E.DMAC.DISABLE;
      --  Bus Lock
      LOCK_B         : CFG0_LOCK_B_Field := A0B.SVD.ATSAM3X8E.DMAC.DISABLE;
      --  Master Interface Arbiter Lock
      LOCK_IF_L      : CFG0_LOCK_IF_L_Field := A0B.SVD.ATSAM3X8E.DMAC.CHUNK;
      --  unspecified
      Reserved_23_23 : A0B.Types.SVD.Bit := 16#0#;
      --  AHB Protection
      ...
      --  FIFO Configuration
      FIFOCFG        : CFG0_FIFOCFG_Field := A0B.SVD.ATSAM3X8E.DMAC.ALAP_CFG;
      --  unspecified
      Reserved_30_31 : A0B.Types.SVD.UInt2 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
