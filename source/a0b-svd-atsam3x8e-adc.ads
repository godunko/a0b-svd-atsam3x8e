...
package A0B.SVD.ATSAM3X8E.ADC is
   pragma Preelaborate;
...
--  channel.
   ...
   type ADC_MR_Register is record
      --  Trigger Enable
      TRGEN          : MR_TRGEN_Field := A0B.SVD.ATSAM3X8E.ADC.DIS;
      --  Trigger Selection
      TRGSEL         : MR_TRGSEL_Field := A0B.SVD.ATSAM3X8E.ADC.ADC_TRIG0;
      --  unspecified
      Reserved_4_4   : A0B.Types.SVD.Bit := 16#0#;
      --  Sleep Mode
      SLEEP          : MR_SLEEP_Field := A0B.SVD.ATSAM3X8E.ADC.NORMAL;
      --  Fast Wake Up
      FWUP           : MR_FWUP_Field := A0B.SVD.ATSAM3X8E.ADC.OFF;
      --  Free Run Mode
      FREERUN        : MR_FREERUN_Field := A0B.SVD.ATSAM3X8E.ADC.OFF;
      --  Prescaler Rate Selection
      PRESCAL        : ADC_MR_PRESCAL_Field := 16#0#;
      --  Start Up Time
      STARTUP        : MR_STARTUP_Field := A0B.SVD.ATSAM3X8E.ADC.SUT0;
      --  Analog Settling Time
      SETTLING       : MR_SETTLING_Field := A0B.SVD.ATSAM3X8E.ADC.AST3;
      --  unspecified
      Reserved_22_22 : A0B.Types.SVD.Bit := 16#0#;
      --  Analog Change
      ANACH          : MR_ANACH_Field := A0B.SVD.ATSAM3X8E.ADC.NONE;
      --  Tracking Time
      ...
      --  Use Sequence Enable
      USEQ           : MR_USEQ_Field := A0B.SVD.ATSAM3X8E.ADC.NUM_ORDER;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
...
--  threshold of the window.
   ...
   type ADC_EMR_Register is record
      --  Comparison Mode
      CMPMODE        : EMR_CMPMODE_Field := A0B.SVD.ATSAM3X8E.ADC.LOW;
      --  unspecified
