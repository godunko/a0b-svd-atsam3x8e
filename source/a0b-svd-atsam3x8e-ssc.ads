...
package A0B.SVD.ATSAM3X8E.SSC is
   pragma Preelaborate;
...
--  end of transfer of the previous data.
   ...
   type SSC_RCMR_Register is record
      --  Receive Clock Selection
      CKS            : RCMR_CKS_Field := A0B.SVD.ATSAM3X8E.SSC.MCK;
      --  Receive Clock Output Mode Selection
      CKO            : RCMR_CKO_Field := A0B.SVD.ATSAM3X8E.SSC.NONE;
      --  Receive Clock Inversion
      CKI            : Boolean := False;
      --  Receive Clock Gating Selection
      CKG            : RCMR_CKG_Field := A0B.SVD.ATSAM3X8E.SSC.CONTINUOUS;
      --  Receive Start Selection
      START          : RCMR_START_Field := A0B.SVD.ATSAM3X8E.SSC.CONTINUOUS;
   ...
   type SSC_RFMR_Register is record
      ...
      --  Receive Frame Sync Output Selection
      FSOS           : RFMR_FSOS_Field := A0B.SVD.ATSAM3X8E.SSC.NONE;
      --  unspecified
      Reserved_23_23 : A0B.Types.SVD.Bit := 16#0#;
      --  Frame Sync Edge Detection
      FSEDGE         : RFMR_FSEDGE_Field := A0B.SVD.ATSAM3X8E.SSC.POSITIVE;
      --  unspecified
...
--  previous data
   ...
   type SSC_TCMR_Register is record
      --  Transmit Clock Selection
      CKS            : TCMR_CKS_Field := A0B.SVD.ATSAM3X8E.SSC.MCK;
      --  Transmit Clock Output Mode Selection
      CKO            : TCMR_CKO_Field := A0B.SVD.ATSAM3X8E.SSC.NONE;
      --  Transmit Clock Inversion
      CKI            : Boolean := False;
      --  Transmit Clock Gating Selection
      CKG            : TCMR_CKG_Field := A0B.SVD.ATSAM3X8E.SSC.CONTINUOUS;
      --  Transmit Start Selection
      START          : TCMR_START_Field := A0B.SVD.ATSAM3X8E.SSC.CONTINUOUS;
      --  unspecified
      Reserved_12_15 : A0B.Types.SVD.UInt4 := 16#0#;
   ...
   type SSC_TFMR_Register is record
      ...
      --  Transmit Frame Sync Output Selection
      FSOS           : TFMR_FSOS_Field := A0B.SVD.ATSAM3X8E.SSC.NONE;
      --  Frame Sync Data Enable
      FSDEN          : Boolean := False;
      --  Frame Sync Edge Detection
      FSEDGE         : TFMR_FSEDGE_Field := A0B.SVD.ATSAM3X8E.SSC.POSITIVE;
      --  unspecified
      Reserved_25_27 : A0B.Types.SVD.UInt3 := 16#0#;
      --  FSLEN Field Extension
