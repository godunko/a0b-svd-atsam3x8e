...
package A0B.SVD.ATSAM3X8E.HSMCI is
   pragma Preelaborate;
   ...
   type HSMCI_DTOR_Register is record
      ...
      --  Data Timeout Multiplier
      DTOMUL        : DTOR_DTOMUL_Field := A0B.SVD.ATSAM3X8E.HSMCI.Val_1;
      --  unspecified
   ...
   type HSMCI_SDCR_Register is record
      --  SDCard/SDIO Slot
      SDCSEL        : SDCR_SDCSEL_Field := A0B.SVD.ATSAM3X8E.HSMCI.SLOTA;
      --  unspecified
      Reserved_2_5  : A0B.Types.SVD.UInt4 := 16#0#;
      --  SDCard/SDIO Bus Width
      SDCBUS        : SDCR_SDCBUS_Field := A0B.SVD.ATSAM3X8E.HSMCI.Val_1;
      --  unspecified
      Reserved_8_31 : A0B.Types.SVD.UInt24 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
...
--  amount of time (HSMCI_CSTOR).
   ...
   type HSMCI_CMDR_Register is record
      ...
      RSPTYP         : CMDR_RSPTYP_Field := A0B.SVD.ATSAM3X8E.HSMCI.NORESP;
      --  Write-only. Special Command
      SPCMD          : CMDR_SPCMD_Field := A0B.SVD.ATSAM3X8E.HSMCI.STD;
      --  Write-only. Open Drain Command
      OPDCMD         : CMDR_OPDCMD_Field := A0B.SVD.ATSAM3X8E.HSMCI.PUSHPULL;
      --  Write-only. Max Latency for Command to Response
      MAXLAT         : CMDR_MAXLAT_Field := A0B.SVD.ATSAM3X8E.HSMCI.Val_5;
      --  unspecified
      Reserved_13_15 : A0B.Types.SVD.UInt3 := 16#0#;
      --  Write-only. Transfer Command
      TRCMD          : CMDR_TRCMD_Field := A0B.SVD.ATSAM3X8E.HSMCI.NO_DATA;
      --  Write-only. Transfer Direction
      TRDIR          : CMDR_TRDIR_Field := A0B.SVD.ATSAM3X8E.HSMCI.WRITE;
      --  Write-only. Transfer Type
      TRTYP          : CMDR_TRTYP_Field := A0B.SVD.ATSAM3X8E.HSMCI.SINGLE;
      --  unspecified
      Reserved_22_23 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Write-only. SDIO Special Command
      IOSPCMD        : CMDR_IOSPCMD_Field := A0B.SVD.ATSAM3X8E.HSMCI.STD;
      --  Write-only. ATA with Command Completion Signal
      ATACS          : CMDR_ATACS_Field := A0B.SVD.ATSAM3X8E.HSMCI.NORMAL;
   ...
   type HSMCI_CSTOR_Register is record
      ...
      --  Completion Signal Timeout Multiplier
      CSTOMUL       : CSTOR_CSTOMUL_Field := A0B.SVD.ATSAM3X8E.HSMCI.Val_1;
      --  unspecified
      Reserved_7_31 : A0B.Types.SVD.UInt25 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type HSMCI_DMA_Register is record
      ...
      --  DMA Channel Read and Write Chunk Size
      CHKSIZE        : DMA_CHKSIZE_Field := A0B.SVD.ATSAM3X8E.HSMCI.Val_1;
      --  unspecified
