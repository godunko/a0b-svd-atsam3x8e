...
--  Ethernet MAC 10/100
package A0B.SVD.ATSAM3X8E.EMAC is
   pragma Preelaborate;
   ...
   type EMAC_NCFGR_Register is record
      ...
      --  MDC clock divider
      CLK            : NCFGR_CLK_Field := A0B.SVD.ATSAM3X8E.EMAC.MCK_32;
      --  Retry test
      RTY            : Boolean := False;
      --  Pause Enable
      PAE            : Boolean := False;
      --  Receive Buffer Offset
      RBOF           : NCFGR_RBOF_Field := A0B.SVD.ATSAM3X8E.EMAC.OFFSET_0;
