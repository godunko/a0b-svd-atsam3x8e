...
package A0B.SVD.ATSAM3X8E.EBI is
   pragma Preelaborate;
   ...
   type SMC_CFG_Register is record
      --  Page Size of the NAND Flash Device
      PAGESIZE       : CFG_PAGESIZE_Field := A0B.SVD.ATSAM3X8E.EBI.PS512;
      --  unspecified
      ...
      --  Data Timeout Multiplier
      DTOMUL         : CFG_DTOMUL_Field := A0B.SVD.ATSAM3X8E.EBI.X1;
      --  unspecified
...
--  (for 8-bit NAND Flash only)
   ...
   type SMC_ECC_MD_Register is record
      ...
      ECC_PAGESIZE  : ECC_MD_ECC_PAGESIZE_Field :=
                       A0B.SVD.ATSAM3X8E.EBI.PS512;
      --  unspecified
      Reserved_2_3  : A0B.Types.SVD.UInt2 := 16#0#;
      --  Type of Correction
      TYPCORREC     : ECC_MD_TYPCORREC_Field := A0B.SVD.ATSAM3X8E.EBI.CPAGE;
      --  unspecified
   ...
   type MODE_Register is record
      ...
      READ_MODE      : MODE0_READ_MODE_Field :=
                        A0B.SVD.ATSAM3X8E.EBI.NRD_CTRL;
      --  Selection of the Control Signal for Write Operation
      WRITE_MODE     : MODE0_WRITE_MODE_Field :=
                        A0B.SVD.ATSAM3X8E.EBI.NWE_CTRL;
      --  unspecified
      Reserved_2_3   : A0B.Types.SVD.UInt2 := 16#0#;
      --  NWAIT Mode
      EXNW_MODE      : MODE0_EXNW_MODE_Field :=
                        A0B.SVD.ATSAM3X8E.EBI.DISABLED;
      --  unspecified
      Reserved_6_7   : A0B.Types.SVD.UInt2 := 16#0#;
      --  Byte Access Type
      BAT            : Boolean := False;
      ...
      --  Data Bus Width
      DBW            : MODE0_DBW_Field := A0B.SVD.ATSAM3X8E.EBI.BIT_8;
      --  unspecified
      Reserved_13_15 : A0B.Types.SVD.UInt3 := 16#0#;
      --  Data Float Time
