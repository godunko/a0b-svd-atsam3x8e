...
package A0B.SVD.ATSAM3X8E.UOTGHS is
   pragma Preelaborate;
...
--  capability.
   ...
   type UOTGHS_DEVCTRL_Register is record
      ...
      SPDCONF        : DEVCTRL_SPDCONF_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.NORMAL;
...
--  triple-bank.
   ...
   type UOTGHS_DEVEPTCFG_Register is record
      ...
      EPBK           : DEVEPTCFG_EPBK_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.Val_1_BANK;
      --  Endpoint Size
      EPSIZE         : DEVEPTCFG_EPSIZE_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.Val_8_BYTE;
      --  unspecified
      Reserved_7_7   : A0B.Types.SVD.Bit := 16#0#;
      --  Endpoint Direction
      EPDIR          : DEVEPTCFG_EPDIR_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.OUT_k;
      --  Automatic Switch
      ...
      EPTYPE         : DEVEPTCFG_EPTYPE_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.CTRL;
      --  Number of transaction per microframe for isochronous endpoint
      NBTRANS        : DEVEPTCFG_NBTRANS_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.Val_0_TRANS;
      --  unspecified
...
--  capability.
   ...
   type UOTGHS_HSTPIPCFG_Register is record
      ...
      PTOKEN         : HSTPIPCFG_PTOKEN_Field :=
                        A0B.SVD.ATSAM3X8E.UOTGHS.SETUP;
      --  Automatic Switch
      AUTOSW         : Boolean := False;
      --  unspecified
      Reserved_11_11 : A0B.Types.SVD.Bit := 16#0#;
      --  Pipe Type
      PTYPE          : HSTPIPCFG_PTYPE_Field := A0B.SVD.ATSAM3X8E.UOTGHS.CTRL;
      --  unspecified
      Reserved_14_15 : A0B.Types.SVD.UInt2 := 16#0#;
   ...
   type UOTGHS_CTRL_Register is record
      ...
      Reserved_23_23 : A0B.Types.SVD.Bit := 16#0#;
      --  UOTGID Pin Enable
      UIDE           : CTRL_UIDE_Field := A0B.SVD.ATSAM3X8E.UOTGHS.UOTGID;
      --  UOTGHS Mode
      UIMOD          : CTRL_UIMOD_Field := A0B.SVD.ATSAM3X8E.UOTGHS.DEVICE;
      --  unspecified
