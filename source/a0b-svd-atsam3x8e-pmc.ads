...
package A0B.SVD.ATSAM3X8E.PMC is
   pragma Preelaborate;
...
--  reads as 0.
   ...
   type CKGR_MOR_Register is record
      ...
      MOSCRCF        : CKGR_MOR_MOSCRCF_Field :=
                        A0B.SVD.ATSAM3X8E.PMC.Val_4_MHz;
      --  unspecified
   ...
   type PMC_MCKR_Register is record
      --  Master Clock Source Selection
      CSS            : PMC_MCKR_CSS_Field := A0B.SVD.ATSAM3X8E.PMC.MAIN_CLK;
      --  unspecified
      Reserved_2_3   : A0B.Types.SVD.UInt2 := 16#0#;
      --  Processor Clock Prescaler
      PRES           : PMC_MCKR_PRES_Field := A0B.SVD.ATSAM3X8E.PMC.CLK_1;
      --  unspecified
   ...
   type PMC_PCK_Register is record
      --  Master Clock Source Selection
      CSS           : PMC_PCK_CSS_Field := A0B.SVD.ATSAM3X8E.PMC.SLOW_CLK;
      --  unspecified
      Reserved_3_3  : A0B.Types.SVD.Bit := 16#0#;
      --  Programmable Clock Prescaler
      PRES          : PMC_PCK_PRES_Field := A0B.SVD.ATSAM3X8E.PMC.CLK_1;
      --  unspecified
...
--  WPEN bit. Always reads as 0.
   ...
   type PMC_PCR_Register is record
      ...
      DIV            : PMC_PCR_DIV_Field :=
                        A0B.SVD.ATSAM3X8E.PMC.PERIPH_DIV_MCK;
      --  unspecified
