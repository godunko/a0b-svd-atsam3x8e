...
package A0B.SVD.ATSAM3X8E.PWM is
   pragma Preelaborate;
...
--  update of synchronous channels
   ...
   type PWM_SCM_Register is record
      ...
      Reserved_8_15  : A0B.Types.SVD.Byte := 16#0#;
      --  Synchronous Channels Update Mode
      UPDM           : SCM_UPDM_Field := A0B.SVD.ATSAM3X8E.PWM.MODE0;
      --  unspecified
   ...
   type CMR_Register is record
      --  Channel Pre-scaler
      CPRE           : CMR0_CPRE_Field := A0B.SVD.ATSAM3X8E.PWM.MCK;
      --  unspecified
      Reserved_4_7   : A0B.Types.SVD.UInt4 := 16#0#;
      --  Channel Alignment
      CALG           : Boolean := False;
