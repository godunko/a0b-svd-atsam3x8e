...
package A0B.SVD.ATSAM3X8E.DACC is
   pragma Preelaborate;
...
--  conversion.
   ...
   type DACC_MR_Register is record
      --  Trigger Enable
      TRGEN          : MR_TRGEN_Field := A0B.SVD.ATSAM3X8E.DACC.DIS;
      --  Trigger Selection
      TRGSEL         : DACC_MR_TRGSEL_Field := 16#0#;
      --  Word Transfer
      WORD           : MR_WORD_Field := A0B.SVD.ATSAM3X8E.DACC.HALF;
      --  Sleep Mode
      SLEEP          : Boolean := False;
      --  Fast Wake up Mode
      ...
      --  User Channel Selection
      USER_SEL       : MR_USER_SEL_Field := A0B.SVD.ATSAM3X8E.DACC.CHANNEL0;
      --  unspecified
      Reserved_18_19 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Tag Selection Mode
      TAG            : MR_TAG_Field := A0B.SVD.ATSAM3X8E.DACC.DIS;
      --  Max Speed Mode
      MAXS           : MR_MAXS_Field := A0B.SVD.ATSAM3X8E.DACC.NORMAL;
      --  unspecified
      Reserved_22_23 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Startup Time Selection
      STARTUP        : MR_STARTUP_Field := A0B.SVD.ATSAM3X8E.DACC.Val_0;
      --  unspecified
