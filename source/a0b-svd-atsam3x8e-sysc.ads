...
package A0B.SVD.ATSAM3X8E.SYSC is
   pragma Preelaborate;
...
--  reads as 0.
   ...
   type RTC_CR_Register is record
      ...
      --  Time Event Selection
      TIMEVSEL       : CR_TIMEVSEL_Field := A0B.SVD.ATSAM3X8E.SYSC.MINUTE;
      --  unspecified
      Reserved_10_15 : A0B.Types.SVD.UInt6 := 16#0#;
      --  Calendar Event Selection
      CALEVSEL       : CR_CALEVSEL_Field := A0B.SVD.ATSAM3X8E.SYSC.WEEK;
      --  unspecified
...
--  output.
   ...
   type SUPC_CR_Register is record
      ...
      VROFF         : CR_VROFF_Field := A0B.SVD.ATSAM3X8E.SYSC.NO_EFFECT;
      --  Write-only. Crystal Oscillator Select
      XTALSEL       : CR_XTALSEL_Field := A0B.SVD.ATSAM3X8E.SYSC.NO_EFFECT;
      --  unspecified
      Reserved_4_23 : A0B.Types.SVD.UInt20 := 16#0#;
      --  Write-only. Password
      KEY           : CR_KEY_Field := CR_KEY_Field_Reset;
...
--  occurs.
   ...
   type SUPC_SMMR_Register is record
      ...
      --  Supply Monitor Sampling Period
      SMSMPL         : SMMR_SMSMPL_Field := A0B.SVD.ATSAM3X8E.SYSC.SMD;
      --  unspecified
      Reserved_11_11 : A0B.Types.SVD.Bit := 16#0#;
      --  Supply Monitor Reset Enable
      SMRSTEN        : SMMR_SMRSTEN_Field :=
                        A0B.SVD.ATSAM3X8E.SYSC.NOT_ENABLE;
      --  Supply Monitor Interrupt Enable
      SMIEN          : SMMR_SMIEN_Field := A0B.SVD.ATSAM3X8E.SYSC.NOT_ENABLE;
      --  unspecified
...
--  are used)
   ...
   type SUPC_MR_Register is record
      ...
      --  Brownout Detector Reset Enable
      BODRSTEN       : MR_BODRSTEN_Field := A0B.SVD.ATSAM3X8E.SYSC.ENABLE;
      --  Brownout Detector Disable
      BODDIS         : MR_BODDIS_Field := A0B.SVD.ATSAM3X8E.SYSC.ENABLE;
      --  VDDIO Ready
      VDDIORDY       : MR_VDDIORDY_Field :=
                        A0B.SVD.ATSAM3X8E.SYSC.VDDIO_PRESENT;
      --  unspecified
      Reserved_15_19 : A0B.Types.SVD.UInt5 := 16#0#;
      --  Oscillator Bypass
      OSCBYPASS      : MR_OSCBYPASS_Field := A0B.SVD.ATSAM3X8E.SYSC.NO_EFFECT;
      --  unspecified
   ...
   type SUPC_WUMR_Register is record
      --  Force Wake-up Enable
      FWUPEN         : WUMR_FWUPEN_Field := A0B.SVD.ATSAM3X8E.SYSC.NOT_ENABLE;
      --  Supply Monitor Wake-up Enable
      SMEN           : WUMR_SMEN_Field := A0B.SVD.ATSAM3X8E.SYSC.NOT_ENABLE;
      --  Real Time Timer Wake-up Enable
      RTTEN          : WUMR_RTTEN_Field := A0B.SVD.ATSAM3X8E.SYSC.NOT_ENABLE;
      --  Real Time Clock Wake-up Enable
      RTCEN          : WUMR_RTCEN_Field := A0B.SVD.ATSAM3X8E.SYSC.NOT_ENABLE;
      --  unspecified
      Reserved_4_7   : A0B.Types.SVD.UInt4 := 16#0#;
      --  Force Wake-up Debouncer Period
      FWUPDBC        : WUMR_FWUPDBC_Field := A0B.SVD.ATSAM3X8E.SYSC.IMMEDIATE;
      --  unspecified
      Reserved_11_11 : A0B.Types.SVD.Bit := 16#0#;
      --  Wake-up Inputs Debouncer Period
      WKUPDBC        : WUMR_WKUPDBC_Field := A0B.SVD.ATSAM3X8E.SYSC.IMMEDIATE;
      --  unspecified
