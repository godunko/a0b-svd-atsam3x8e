...
package A0B.SVD.ATSAM3X8E.TC is
   pragma Preelaborate;
   ...
   type CMR_Register is record
      --  Clock Selection
      TCCLKS         : CMR0_TCCLKS_Field := A0B.SVD.ATSAM3X8E.TC.TIMER_CLOCK1;
      --  Clock Invert
      CLKI           : Boolean := False;
      --  Burst Signal Selection
      BURST          : CMR0_BURST_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Counter Clock Stopped with RB Loading
      LDBSTOP        : Boolean := False;
      --  Counter Clock Disable with RB Loading
      LDBDIS         : Boolean := False;
      --  External Trigger Edge Selection
      ETRGEDG        : CMR0_ETRGEDG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      ...
      WAVE           : Boolean := False;
      --  RA Loading Edge Selection
      LDRA           : CMR0_LDRA_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RB Loading Edge Selection
      LDRB           : CMR0_LDRB_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  unspecified
   ...
   type TC0_CMR0_WAVE_EQ_1_Register is record
      ...
      TCCLKS  : CMR0_WAVE_EQ_1_TCCLKS_Field :=
                 A0B.SVD.ATSAM3X8E.TC.TIMER_CLOCK1;
      --  Clock Invert
      CLKI    : Boolean := False;
      --  Burst Signal Selection
      BURST   : CMR0_WAVE_EQ_1_BURST_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Counter Clock Stopped with RC Compare
      CPCSTOP : Boolean := False;
      --  Counter Clock Disable with RC Compare
      CPCDIS  : Boolean := False;
      --  External Event Edge Selection
      EEVTEDG : CMR0_WAVE_EQ_1_EEVTEDG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Selection
      EEVT    : CMR0_WAVE_EQ_1_EEVT_Field := A0B.SVD.ATSAM3X8E.TC.TIOB;
      --  External Event Trigger Enable
      ENETRG  : Boolean := False;
      --  Waveform Selection
      WAVSEL  : CMR0_WAVE_EQ_1_WAVSEL_Field := A0B.SVD.ATSAM3X8E.TC.UP;
      --  Waveform Mode
      WAVE    : Boolean := False;
      --  RA Compare Effect on TIOA
      ACPA    : CMR0_WAVE_EQ_1_ACPA_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RC Compare Effect on TIOA
      ACPC    : CMR0_WAVE_EQ_1_ACPC_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Effect on TIOA
      AEEVT   : CMR0_WAVE_EQ_1_AEEVT_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Software Trigger Effect on TIOA
      ASWTRG  : CMR0_WAVE_EQ_1_ASWTRG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RB Compare Effect on TIOB
      BCPB    : CMR0_WAVE_EQ_1_BCPB_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RC Compare Effect on TIOB
      BCPC    : CMR0_WAVE_EQ_1_BCPC_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Effect on TIOB
      BEEVT   : CMR0_WAVE_EQ_1_BEEVT_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Software Trigger Effect on TIOB
      BSWTRG  : CMR0_WAVE_EQ_1_BSWTRG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type TC0_CMR1_WAVE_EQ_1_Register is record
      ...
      CLKI    : Boolean := False;
      --  Burst Signal Selection
      BURST   : CMR1_WAVE_EQ_1_BURST_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Counter Clock Stopped with RC Compare
      CPCSTOP : Boolean := False;
      --  Counter Clock Disable with RC Compare
      CPCDIS  : Boolean := False;
      --  External Event Edge Selection
      EEVTEDG : CMR1_WAVE_EQ_1_EEVTEDG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Selection
      EEVT    : CMR1_WAVE_EQ_1_EEVT_Field := A0B.SVD.ATSAM3X8E.TC.TIOB;
      --  External Event Trigger Enable
      ENETRG  : Boolean := False;
      --  Waveform Selection
      WAVSEL  : CMR1_WAVE_EQ_1_WAVSEL_Field := A0B.SVD.ATSAM3X8E.TC.UP;
      --  Waveform Mode
      WAVE    : Boolean := False;
      --  RA Compare Effect on TIOA
      ACPA    : CMR1_WAVE_EQ_1_ACPA_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RC Compare Effect on TIOA
      ACPC    : CMR1_WAVE_EQ_1_ACPC_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Effect on TIOA
      AEEVT   : CMR1_WAVE_EQ_1_AEEVT_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Software Trigger Effect on TIOA
      ASWTRG  : CMR1_WAVE_EQ_1_ASWTRG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RB Compare Effect on TIOB
      BCPB    : CMR1_WAVE_EQ_1_BCPB_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RC Compare Effect on TIOB
      BCPC    : CMR1_WAVE_EQ_1_BCPC_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Effect on TIOB
      BEEVT   : CMR1_WAVE_EQ_1_BEEVT_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Software Trigger Effect on TIOB
      BSWTRG  : CMR1_WAVE_EQ_1_BSWTRG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type TC0_CMR2_WAVE_EQ_1_Register is record
      ...
      CLKI    : Boolean := False;
      --  Burst Signal Selection
      BURST   : CMR2_WAVE_EQ_1_BURST_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Counter Clock Stopped with RC Compare
      CPCSTOP : Boolean := False;
      --  Counter Clock Disable with RC Compare
      CPCDIS  : Boolean := False;
      --  External Event Edge Selection
      EEVTEDG : CMR2_WAVE_EQ_1_EEVTEDG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Selection
      EEVT    : CMR2_WAVE_EQ_1_EEVT_Field := A0B.SVD.ATSAM3X8E.TC.TIOB;
      --  External Event Trigger Enable
      ENETRG  : Boolean := False;
      --  Waveform Selection
      WAVSEL  : CMR2_WAVE_EQ_1_WAVSEL_Field := A0B.SVD.ATSAM3X8E.TC.UP;
      --  Waveform Mode
      WAVE    : Boolean := False;
      --  RA Compare Effect on TIOA
      ACPA    : CMR2_WAVE_EQ_1_ACPA_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RC Compare Effect on TIOA
      ACPC    : CMR2_WAVE_EQ_1_ACPC_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Effect on TIOA
      AEEVT   : CMR2_WAVE_EQ_1_AEEVT_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Software Trigger Effect on TIOA
      ASWTRG  : CMR2_WAVE_EQ_1_ASWTRG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RB Compare Effect on TIOB
      BCPB    : CMR2_WAVE_EQ_1_BCPB_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  RC Compare Effect on TIOB
      BCPC    : CMR2_WAVE_EQ_1_BCPC_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  External Event Effect on TIOB
      BEEVT   : CMR2_WAVE_EQ_1_BEEVT_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
      --  Software Trigger Effect on TIOB
      BSWTRG  : CMR2_WAVE_EQ_1_BSWTRG_Field := A0B.SVD.ATSAM3X8E.TC.NONE;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type TC0_BMR_Register is record
      --  External Clock Signal 0 Selection
      TC0XC0S        : BMR_TC0XC0S_Field := A0B.SVD.ATSAM3X8E.TC.TCLK0;
      --  External Clock Signal 1 Selection
      TC1XC1S        : BMR_TC1XC1S_Field := A0B.SVD.ATSAM3X8E.TC.TCLK1;
      --  External Clock Signal 2 Selection
      TC2XC2S        : BMR_TC2XC2S_Field := A0B.SVD.ATSAM3X8E.TC.TCLK2;
      --  unspecified
