...
package A0B.SVD.ATSAM3X8E.UART is
   pragma Preelaborate;
   ...
   type UART_MR_Register is record
      ...
      --  Parity Type
      PAR            : MR_PAR_Field := A0B.SVD.ATSAM3X8E.UART.EVEN;
      --  unspecified
      Reserved_12_13 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Channel Mode
      CHMODE         : MR_CHMODE_Field := A0B.SVD.ATSAM3X8E.UART.NORMAL;
      --  unspecified
